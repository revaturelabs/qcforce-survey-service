...
public class QuestionController {
	...
	@GetMapping("/question/{questionType}")
	public List<Question> getQuestionByQuestionType(@PathVariable("questionType")String questionType) {
		return (List<Question>) questionService.getQuestionByQuestionType(questionType);
	}

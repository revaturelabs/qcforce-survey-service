...
public class EmailServiceImpl implements EmailService {
	...
	public EmailServiceImpl() {
		...
		this.session = Session.getInstance(prop, new Authenticator() {
			...
			protected PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication(emailServiceUsername, emailServicePassword);
			}
		});
	}
	 ...
	 * @throws AddressException   exception thrown when a wrongly formatted address
	 *                            is encountered.
	 * @throws MessagingException base class for all exceptions thrown by the
	 *                            Messaging classes
	 */
